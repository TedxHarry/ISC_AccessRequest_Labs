...
| Original/effective user levels and fresh sessions | |
| Henry pending control and read-only observations | |
| Reassignment actor, Samuel decision and request ID | |
| Taylor/Liam selected IDs and individual cancellation results | |
| Audit evidence and native membership checks | |
| Restored levels and final restrictions | |
