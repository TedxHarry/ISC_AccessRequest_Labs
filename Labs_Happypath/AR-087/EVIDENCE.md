...
| Original feature toggle and both reviewer schedules | |
| Active window/time zone and delegate identity | |
| A/B request IDs and automatic reassignment evidence | |
| Samuel decisions and native absence | |
| Schedule removal and fresh routing result | |
| Restored rows, owner and pending-work check | |
