...
| Original/new date policy and UTC values | |
| Omitted-date response, audit and effective date | |
| Excessive-date error and valid scheduled assignment | |
| Future-assignment removal and fallback-field deferral | |
| Two Sofia grant IDs and account identifiers | |
| Targeted revoke, standard cleanup and final memberships | |
