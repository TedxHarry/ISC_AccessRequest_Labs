...
| Workspace/integration and user mapping | |
| Original entitlement/workspace settings | |
| Native control grant/removal IDs | |
| External reference and matching ISC request | |
| Decision channel and native grant/removal | |
| Denial, status differences and unavailable fields | |
| Final restoration and unresolved delivery evidence | |
