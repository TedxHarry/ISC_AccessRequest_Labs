...
Compare the request reassignment, owner edit in AR-072 and Overwrite Current Approver. State which changes one task, which changes future owner-based routing and which makes a decision. Use recorded events instead of experimenting on another user’s work.
