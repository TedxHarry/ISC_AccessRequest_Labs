...
Without reopening the walkthrough, write the profile name, two groups, owner, grant/removal reviewer and final state for Liam and Olivia. Compare your answer with the saved configuration and native checks. Explain what would prevent you from accepting a partly provisioned bundle.
