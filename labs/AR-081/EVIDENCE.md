...
| Original global/profile/entitlement configuration | |
| Group member IDs and requester-visible list | |
| Decision actor and other reviewer queue | |
| Grant and reviewed removal IDs/native checks | |
| Primary Owner and All Owners request/assignee results | |
| Restored owners, flag and final state | |
