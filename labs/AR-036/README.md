...
4. Record the incorrect value, corrected value and fresh-request result. Save `AR-036-05.png` with separate captures for the fault and restored behavior. If an item was submitted accidentally, deny it as Ava and verify no membership.
...
| AR-036-05.png | Engineering practice: wrong value and restored fresh-form behavior |
