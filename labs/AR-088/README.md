...
Choose one failed or unexecuted row. Write the smallest additional observation that would distinguish a configuration error from a service regression. Keep the original failure evidence; do not replace it with a later success.
