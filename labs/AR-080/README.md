...
Cancel the reauthentication prompt on a fresh isolated request before deciding. Inspect whether the review remains actionable and whether native access remains absent. Resolve it by completing authentication or denying; a canceled prompt must not be reported as a completed decision.
