...
Use the capture list at the end of the [lab](README.md). Name the files `AR-056-01.png`, `AR-056-02.png` and so on in that order. Record a separate filename for each test variant. Exclude credentials and callback secrets.
