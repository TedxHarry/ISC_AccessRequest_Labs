...
3. On the Production Support item, configure an approval timeout of 2 days, one reminder starting after 1 day, and a daily schedule/time zone you can observe. Add an escalation to Samuel (`acme.e024`) after 1 day if the item editor supports this combination. Save the schedule preview. Keep expiration as denial/Expire, not automatic approval.
