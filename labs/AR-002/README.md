...
Confirm Lucas → Daniel → Morgan and record Lucas’s current E003 manager reference before the reversible practice. Label earlier activity as historical when repeating the lab.
