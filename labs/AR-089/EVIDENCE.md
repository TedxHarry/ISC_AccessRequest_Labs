...
| Original accounts/memberships and object IDs | |
| Requested grant and single-person automatic eligibility | |
| Addition/apply time and both identity results | |
| Definition removal and independent residual access | |
| Supported or manual cleanup method and review evidence | |
| Final memberships, disabled objects and change handover | |
