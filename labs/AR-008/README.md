...
Confirm the three ordinary-user sessions and administrator session still work. Keep authentication settings and registrations; do not resend invitations to working users. Label earlier activity as historical when repeating the lab.
