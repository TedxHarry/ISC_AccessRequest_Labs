...
Use the capture list at the end of the [lab](README.md). Name the files `AR-077-01.png`, `AR-077-02.png` and so on in that order. Record a separate filename for each test variant. Exclude credentials and callback secrets.
